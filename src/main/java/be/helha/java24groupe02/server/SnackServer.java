...
public class SnackServer {
    ...
    protected static final List<ClientHandler> clients = new CopyOnWriteArrayList<>();
    protected static ProductDB productDB = new ProductDB();
    ...
    protected static class ClientHandler implements Runnable {
         ...
         */
        protected void sendInitialProductList() throws IOException {
            try {
         ...
         */
        protected void updateProductStock(int productId, int clientStock) {
            try {
         ...
         */
        protected void notifyAllClients() {
            try {
                List<Product> products = productDB.getAllProductsFromDatabase();
